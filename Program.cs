    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            using (var context = new TodoContext()) 
            {
                ...
                context.TodoItems.Add(std);
                context.SaveChanges();
            }


            //Provide your configuration and keys here, this allows the client to function as expected.
            string apiKey = "pwulgPgARYojE9OBMdYAeqS0vkeXMwCoZBcGXZPiyHFiwaPjogofaNHbJZPy3BXG";
            string secretKey = "cK89zpzEdouDurcDtDpeDtvCsk9Nv7q7uGkj9wqpOjgrMvlgoRcWA5ieTwcKT8dp";
            ...
            if (DEBUG_ALL)
            {
                ...
                {
                    System.Console.WriteLine(badRequestException.Message);
                }
